 ...
 * 
 */
package org.bluevox.inc.ch02.web;
...
import org.bluevox.inc.web.ResourceNotFoundException;

/**
 * 
 * Spring Web MVC controller exposing RESTFUL interface for contact-related operations.
 * 
 * @author wnorman
 *
 */
...
public class ContactController {
	...
	public String createContact(
		...
		if (!result.hasErrors()) {
			...
			//Correct RESTful semantics involve setting the status and location 
			// but these will be overridden if createContactSuccessViewName 
			// issues a redirect.
	...
	/**
	 * Places a list containing all contacts on the passed model
	 * and returns the logical view name for displaying the 
	 * contact list.
	 * 
	 * @param model
	 * 
	...
	/**
	 * *Places the requested contact on the passed model if it exists and returns
	 * the logical view name for displaying the contact. 
	 * Throws a {@link ResourceNotFoundException} and returns an HTTP 404 (not found) 
	 * to the client if the request contact doesn't exits.
	 * 
	 * @param id
	 * 		contact ID
	 * @param model
	 ...
	 * 		if specified contact does not exist
	 */
...
//	Helpers
	...
	private void setActionAndMethod(HttpServletRequest req, String action,
		String method) {
